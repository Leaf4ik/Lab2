...
b1 = InlineKeyboardButton('Где можно курить и что', callback_data="q1")
b2 = InlineKeyboardButton('Где лучше избавляться от голода', callback_data="q2")
...
async def cmd_start(message: types.Message):
    ...
    await bot.send_message(message.from_user.id,
                           text="Здравстуйте!\nЯ крутой тип могу помочь вам школоте с учёбой в ОмГТУ!\nSWAG!!!",
                           reply_markup=privet)
...
async def question1(call: types.CallbackQuery):
    ...
    await bot.send_message(call.from_user.id,
                           "Парить и курить у входа в восьмой корпус и за пределами территории ОмГТУ.",
